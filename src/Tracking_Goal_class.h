...
struct Tracking_Goal {
  ...
  Escher_TimeStamp_t session_startTime;  /* * session_startTime (R13)(R9)(R11) */
  i_t spec_sequenceNumber;  /* * spec_sequenceNumber (R9) */
  i_t ID;  /* * ID */
  r_t startingPoint;  /* - startingPoint */
  GPS_Watch_GoalDisposition_t disposition;  /* - disposition */
...
void Tracking_Goal_op_initialize(  const i_t );
void Tracking_Goal_op_calculateStart( Tracking_Goal * );
GPS_Watch_GoalDisposition_t Tracking_Goal_op_evaluateAchievement( Tracking_Goal * );
...
/*
 * instance event:  Goal4:'evaluationComplete'
 */
typedef struct {
  EVENT_BASE_ATTRIBUTE_LIST         /* base attributes of all event classes */
  /* Note:  no supplemental data for this event */
} Tracking_Goalevent4;
extern const Escher_xtUMLEventConstant_t Tracking_Goalevent4c;
/*
...
#define Tracking_Goal_STATE_4 4  /* state [4]:  (Evaluating) */
/*
...
#define TRACKING_GOALEVENT4NUM 3  /* Goal4:'evaluationComplete' */
