...
struct Tracking_TrackPoint {
  ...
  Escher_TimeStamp_t session_startTime;  /* * session_startTime (R1)(R3)(R2) */
  i_t time;  /* * time */
  r_t longitude;  /* - longitude */
  r_t latitude;  /* - latitude */
  i_t next_time;  /* - next_time (R2) */
...
void Tracking_TrackPoint_R3_Link_has_last( Tracking_TrackLog *, Tracking_TrackPoint * );
void Tracking_TrackPoint_R3_Unlink_has_last( Tracking_TrackLog *, Tracking_TrackPoint * );
