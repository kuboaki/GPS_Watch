...
#ifndef GPS_WATCH_SYS_TYPES_H
#define GPS_WATCH_SYS_TYPES_H
#ifdef	__cplusplus
extern	"C"	{
#endif
...
#define ESCHER_SYS_MAX_SELF_EVENTS 21
...
#define ESCHER_SYS_MAX_XTUML_TIMERS 29
 ...
 */
typedef enum {
 GPS_Watch_GoalCriteria__UNINITIALIZED__e = -1,
 GPS_Watch_GoalCriteria_HeartRate_e = 0,
 GPS_Watch_GoalCriteria_Pace_e = 1
} GPS_Watch_GoalCriteria_t;
/*
 * Enumerated Data Type:  GoalDisposition
 */
typedef enum {
 GPS_Watch_GoalDisposition__UNINITIALIZED__e = -1,
 GPS_Watch_GoalDisposition_Achieving_e = 0,
 GPS_Watch_GoalDisposition_Increase_e = 1,
 GPS_Watch_GoalDisposition_Decrease_e = 2
} GPS_Watch_GoalDisposition_t;
/*
 * Enumerated Data Type:  GoalSpan
 */
typedef enum {
 GPS_Watch_GoalSpan__UNINITIALIZED__e = -1,
 GPS_Watch_GoalSpan_Distance_e = 0,
 GPS_Watch_GoalSpan_Time_e = 1
} GPS_Watch_GoalSpan_t;
/*
 * Enumerated Data Type:  Indicator
 */
typedef enum {
 GPS_Watch_Indicator__UNINITIALIZED__e = -1,
 GPS_Watch_Indicator_Blank_e = 0,
 GPS_Watch_Indicator_Down_e = 1,
 GPS_Watch_Indicator_Flat_e = 2,
 GPS_Watch_Indicator_Up_e = 3
} GPS_Watch_Indicator_t;
/*
 * Enumerated Data Type:  Unit
 */
typedef enum {
 GPS_Watch_Unit__UNINITIALIZED__e = -1,
 GPS_Watch_Unit_km_e = 0,
 GPS_Watch_Unit_meters_e = 1,
 GPS_Watch_Unit_minPerKm_e = 2,
 GPS_Watch_Unit_kmPerHour_e = 3,
 GPS_Watch_Unit_miles_e = 4,
 GPS_Watch_Unit_yards_e = 5,
 GPS_Watch_Unit_feet_e = 6,
 GPS_Watch_Unit_minPerMile_e = 7,
 GPS_Watch_Unit_mph_e = 8,
 GPS_Watch_Unit_bpm_e = 9,
 GPS_Watch_Unit_laps_e = 10
} GPS_Watch_Unit_t;
/*
 * Enumerated Data Type:  UIGoalCriteria
 */
typedef enum {
 GPS_Watch_UIGoalCriteria__UNINITIALIZED__e = -1,
 GPS_Watch_UIGoalCriteria_HeartRate_e = 0,
 GPS_Watch_UIGoalCriteria_Pace_e = 1
} GPS_Watch_UIGoalCriteria_t;
/*
 * Enumerated Data Type:  UIGoalSpan
 */
typedef enum {
 GPS_Watch_UIGoalSpan__UNINITIALIZED__e = -1,
 GPS_Watch_UIGoalSpan_Distance_e = 0,
 GPS_Watch_UIGoalSpan_Time_e = 1
} GPS_Watch_UIGoalSpan_t;
/*
 * Enumerated Data Type:  UIIndicator
 */
typedef enum {
 GPS_Watch_UIIndicator__UNINITIALIZED__e = -1,
 GPS_Watch_UIIndicator_Blank_e = 0,
 GPS_Watch_UIIndicator_Down_e = 1,
 GPS_Watch_UIIndicator_Flat_e = 2,
 GPS_Watch_UIIndicator_Up_e = 3
} GPS_Watch_UIIndicator_t;
/*
 * Enumerated Data Type:  UIUnit
 */
typedef enum {
 GPS_Watch_UIUnit__UNINITIALIZED__e = -1,
 GPS_Watch_UIUnit_km_e = 0,
 GPS_Watch_UIUnit_meters_e = 1,
 GPS_Watch_UIUnit_minPerKm_e = 2,
 GPS_Watch_UIUnit_kmPerHour_e = 3,
 GPS_Watch_UIUnit_miles_e = 4,
 GPS_Watch_UIUnit_yards_e = 5,
 GPS_Watch_UIUnit_feet_e = 6,
 GPS_Watch_UIUnit_minPerMile_e = 7,
 GPS_Watch_UIUnit_mph_e = 8,
 GPS_Watch_UIUnit_bpm_e = 9,
 GPS_Watch_UIUnit_laps_e = 10
} GPS_Watch_UIUnit_t;
