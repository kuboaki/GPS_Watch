...
void Tracking_WorkoutSession_op_initialize( void );
void Tracking_WorkoutSession_op_reset( Tracking_WorkoutSession * );
r_t Tracking_WorkoutSession_op_getCurrentSpeed( Tracking_WorkoutSession * );
r_t Tracking_WorkoutSession_op_getCurrentPace( Tracking_WorkoutSession * );
i_t Tracking_WorkoutSession_op_getCurrentHeartRate( Tracking_WorkoutSession * );
